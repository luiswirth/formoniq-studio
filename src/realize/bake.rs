...
use regge::coord::reach::vertex_reach;
use simplicial::Dim;
...
pub fn directed_edges(t: [u32; 3]) -> [(u32, u32); 3] {
...
/// engine's one indexing convention, so a triangle list read off one has an
